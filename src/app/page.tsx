      ...
      <section className="py-10 bg-slate-50 border-b border-slate-100">
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-x-12 gap-y-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                ...
                <div className="text-xl font-bold font-heading flex items-center gap-2"><Globe className="h-5 w-5"/> GlobalLogistics</div>
                <div className="text-xl font-bold font-heading flex items-center gap-2"><Anchor className="h-5 w-5"/> EuroTrade</div>
                <div className="text-xl font-bold font-heading flex items-center gap-2"><Truck className="h-5 w-5"/> AsiaConnect</div>
                <div className="text-xl font-bold font-heading flex items-center gap-2"><ShieldCheck className="h-5 w-5"/> PacificLine</div>
            </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    ...
                    <Card key={i} className="group hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border-slate-100 bg-card/50 backdrop-blur-sm cursor-pointer h-full">
                        <CardHeader>
