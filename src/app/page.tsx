    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container relative z-10 px-4 md:px-8 text-center max-w-4xl mx-auto">
          <FadeIn delay={0.2}>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 font-heading">
                {dict.hero.title_prefix} <span className="text-secondary">{dict.hero.title_highlight}</span>
            </h1>
          </FadeIn>
      ...
      <section className="py-10 bg-slate-50 border-b border-slate-100">
        <div className="container mx-auto px-4 text-center">
            <FadeIn delay={0.2}>
                <p className="text-xs font-bold text-muted-foreground mb-6 uppercase tracking-widest">{dict.trust.label}</p>
            </FadeIn>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
                <FadeIn>
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 font-heading text-primary">{dict.services.title}</h2>
                </FadeIn>
                <FadeIn delay={0.2}>
                    <p className="text-muted-foreground text-lg">{dict.services.subtitle}</p>
                </FadeIn>
            </div>
                ...
                {[
                    {
                        ...
                        icon: Globe,
                        desc: dict.services.sourcing.desc
                    },
                    {
                        title: dict.services.logistics.title,
                        icon: Truck,
                        desc: dict.services.logistics.desc
                    },
                    {
                        title: dict.services.qc.title,
                        icon: ShieldCheck,
                        desc: dict.services.qc.desc
                    }
                ].map((service, i) => (
                        ...
                        <Card className="group hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border-slate-100 bg-card/50 backdrop-blur-sm cursor-pointer h-full">
                            ...
                            <CardContent>
                                ...
                                <Link href="/services" className="text-primary font-bold flex items-center gap-2 group-hover:gap-3 transition-all text-sm uppercase tracking-wide">
                                    {dict.services.learn_more} <ArrowRight className="h-4 w-4" />
                                </Link>
                            </CardContent>
                        </Card>
                    </FadeIn>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  <div>
                      <FadeIn direction="right">
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 font-heading">{dict.why_us.title}</h2>
                      </FadeIn>
                      <FadeIn direction="right" delay={0.2}>
                        <p className="text-primary-foreground/80 text-lg mb-8 leading-relaxed">
                            {dict.why_us.subtitle}
                        </p>
                      </FadeIn>
                      <div className="space-y-6">
                          {dict.why_us.points.map((item, i) => (
                    ...
                    <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10">
                        ...
                        <div className="absolute bottom-8 left-8 right-8">
                            <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl border border-white/20">
                                <div className="text-3xl font-bold text-white mb-1">{dict.why_us.stats_title}</div>
                                <div className="text-white/80">{dict.why_us.stats_desc}</div>
                            </div>
                        </div>
                    </div>
                  </FadeIn>
      ...
      <section className="py-24 bg-slate-50">
          <div className="container mx-auto px-4 text-center max-w-3xl">
              <FadeIn>
                <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary font-heading">{dict.cta_section.title}</h2>
              </FadeIn>
              <FadeIn delay={0.2}>
