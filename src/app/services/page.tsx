        ...
        <div className="container mx-auto px-4 md:px-8">
            ...
            <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
                ...
                <FadeIn direction="left" delay={0.2} className="w-full md:w-1/2">
                    <div className="bg-slate-100 rounded-2xl h-[350px] relative overflow-hidden shadow-lg">
                        <Image
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                    ...
                    <FadeIn key={i} delay={i * 0.2} fullWidth>
                        <Card className="relative border-none shadow-sm bg-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300 h-full">
                            <CardHeader>
